...
static void ajoute_bande(Bande **liste,
                         size_t *nb,
                         size_t *cap,
                         int deb,
                         int fin) {
    ...
    if (*nb == *cap) {
        ...
        Bande *tmp = (Bande *)realloc(*liste, cap_nouv * sizeof(Bande));
        if (!tmp)
            return;
        *liste = tmp;
        *cap = cap_nouv;
...
Bande *trouve_band_h(const unsigned char *pix,
                     int larg,
                     int haut,
                     size_t *nb_sortie) {
...
Bande *trouve_band_v(const unsigned char *pix,
                     int larg,
                     int haut,
                     size_t *nb_sortie) {
